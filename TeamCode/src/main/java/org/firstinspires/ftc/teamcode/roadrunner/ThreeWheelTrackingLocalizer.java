...
public class ThreeWheelTrackingLocalizer extends com.acmerobotics.roadrunner.localization.ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 13.74153543; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 7.8149606; // in; offset of the lateral wheel
